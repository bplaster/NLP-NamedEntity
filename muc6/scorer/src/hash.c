#ifdef	SCCSID
static	char SccsId[] = "@(#)hash.c	101.1 04 Oct 1994 Copyright 1992 SAIC";
#endif
/*
 * --BEGIN--
 ...
 *					    function.
 *	long		(*hash)();	(i) A pointer to a hash function.
 *	int		count;		(i) Number of segments to preallocate.
 *
 *
