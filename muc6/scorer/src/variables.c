...
#ifndef lint
static char SccsId[] = "@(#)variables.c	101.1 04 Oct 1994 Copyright 1992 Science Applications International Corporation.";
#endif
...
static long	var_hash (char *elt);

#else	/* ! __STDC__ */
static int	var_compare ();
static void	var_release();
static long	var_hash ();
