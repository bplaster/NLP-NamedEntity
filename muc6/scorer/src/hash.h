...
#ifdef SCCSID
static char SccsId_hash_h[] = " @(#)hash.h	101.1 04 Oct 1994  Copyright 1990 Science Applications International Corporation";
#endif
...
static long		DefaultHash (char *key);
static int		DefaultCompare (char *k1, char *k2);
static long		Hash (HashTable *table, char *key);
